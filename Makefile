...
$(ACLOCAL_M4):  configure.in  acinclude.m4 m4/codeset.m4 m4/gettext.m4 \
		m4/glibc21.m4 m4/iconv.m4 m4/isc-posix.m4 \
		m4/lcmessage.m4 m4/lib-ld.m4 m4/lib-link.m4 \
		m4/lib-prefix.m4 m4/progtest.m4
...
install-pod_racer_clonedocDATA: $(pod_racer_clonedoc_DATA)
	@$(NORMAL_INSTALL)
	$(mkinstalldirs) $(DESTDIR)$(pod_racer_clonedocdir)
	@list='$(pod_racer_clonedoc_DATA)'; for p in $$list; do \
	  if test -f $(srcdir)/$$p; then \
	    echo " $(INSTALL_DATA) $(srcdir)/$$p $(DESTDIR)$(pod_racer_clonedocdir)/$$p"; \
	    $(INSTALL_DATA) $(srcdir)/$$p $(DESTDIR)$(pod_racer_clonedocdir)/$$p; \
	  else if test -f $$p; then \
	    echo " $(INSTALL_DATA) $$p $(DESTDIR)$(pod_racer_clonedocdir)/$$p"; \
	    $(INSTALL_DATA) $$p $(DESTDIR)$(pod_racer_clonedocdir)/$$p; \
	  fi; fi; \
	done

uninstall-pod_racer_clonedocDATA:
	@$(NORMAL_UNINSTALL)
	list='$(pod_racer_clonedoc_DATA)'; for p in $$list; do \
	  rm -f $(DESTDIR)$(pod_racer_clonedocdir)/$$p; \
	done
...
install-data-am: install-pod_racer_clonedocDATA
install-data: install-data-recursive

install-am: all-am
	@$(MAKE) $(AM_MAKEFLAGS) install-exec-am install-data-am
install: install-recursive
uninstall-am: uninstall-pod_racer_clonedocDATA
...
uninstall-pod_racer_clonedocDATA install-pod_racer_clonedocDATA \
