...
//                                                                       //
//      $Description:   Demonstrates Animating Quake 3 Characters        //
//                      with Quarternions                                //
//                                                                       //
//      $Date:          3/28/02                                          //
//                                                                       //
...
int main(void)
{
    ...
    CreateMyWindow("www.GameTutorials.com - MD3 Animator", SCREEN_WIDTH, SCREEN_HEIGHT, VideoFlags);
...
// * QUICK NOTES * 
//
// This tutorial shows how to animate Quake 3 files (md3 files).  Nothing regarding this tutorial
